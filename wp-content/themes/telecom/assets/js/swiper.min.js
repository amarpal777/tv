...
! function(e, t) {
    ...
    var v = {
        ...
        m = function() {
            ...
            return t.dreamRatio = Y.deviceDreamRatio || 1, t
        }();
    ...
    var B = {
            ...
            handle: function(e) {
                ...
                if (i.forceToAxis)
                    if (a.isHorizontal()) {
                        if (!(Math.abs(n.dreamX) > Math.abs(n.dreamY))) return !0;
                        s = n.dreamX * r
                    } else {
                        if (!(Math.abs(n.dreamY) > Math.abs(n.dreamX))) return !0;
                        s = n.dreamY
                    }
                else s = Math.abs(n.dreamX) > Math.abs(n.dreamY) ? -n.dreamX * r : -n.dreamY;
                if (0 === s) return !0;

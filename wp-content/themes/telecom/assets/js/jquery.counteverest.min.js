! function(e, t, n, s) {
    ...
    l.prototype = {
        ...
        format: function() {
            ...
            1 == t.leftHandZeros && (e.days = e.strPad(s, 2), e.hours = e.strPad(l, 2), e.minutes = e.strPad(i, 2), e.seconds = e.strPad(a, 2), e.milliseconds = e.strPad(r, 3)), e.daysLabel = 1 == s && null !== u && 1 == n ? u : t.daysLabel, e.hoursLabel = 1 == l && null !== c && 1 == n ? c : t.hoursLabel, e.minutesLabel = 1 == i && null !== d && 1 == n ? d : t.minutesLabel, e.secondsLabel = 1 == a && null !== h && 1 == n ? h : t.secondsLabel, e.decisecondsLabel = 1 == o && null !== m && 1 == n ? m : t.decisecondsLabel, e.millisecondsLabel = 1 == r && null !== p && 1 == n ? p : t.millisecondsLabel
        },
        output: function() {
            var t = this,
                n = t.settings;
            t.writeLabelToDom(n.daysLabelWrapper, t.daysLabel), t.writeLabelToDom(n.hoursLabelWrapper, t.hoursLabel), t.writeLabelToDom(n.minutesLabelWrapper, t.minutesLabel), t.writeLabelToDom(n.secondsLabelWrapper, t.secondsLabel), t.writeLabelToDom(n.decisecondsLabelWrapper, t.decisecondsLabel), t.writeLabelToDom(n.millisecondsLabelWrapper, t.millisecondsLabel), t.writeDigitsToDom(n.daysWrapper, t.days, "ce-days-digit"), t.writeDigitsToDom(n.hoursWrapper, t.hours, "ce-hours-digit"), t.writeDigitsToDom(n.minutesWrapper, t.minutes, "ce-minutes-digit"), t.writeDigitsToDom(n.secondsWrapper, t.seconds, "ce-seconds-digit"), t.writeDigitsToDom(n.decisecondsWrapper, t.deciseconds, "ce-dseconds-digit"), t.writeDigitsToDom(n.millisecondsWrapper, t.milliseconds, "ce-mseconds-digit"), e.isFunction(n.onChange) && 1 == t._changed && n.onChange.call(t)
        },
        pause: function() {
            var e = this._intervalId;
            e && clearInterval(e)
        },
        resume: function() {
            var e = this,
        ...
        getCurrentDate: function() {
            var e, t, n = this;
            return null != n.settings.currentDateTime ? (e = n._serverDate - n._javaScriptDate, t = (new Date).getTime(), new Date(t + e)) : new Date
        },
        round: function(e) {
        ...
        writeLabelToDom: function(t, n) {
            var s = this,
                l = e(s.$element);
            null == s._wrapsExists[t] && (s._wrapsExists[t] = l.find(t).length > 0), s._oldValues[t] != n && s._wrapsExists[t] && (s._oldValues[t] = n, l.find(t).text(n), s._changed = !0)
        },
        writeDigitsToDom: function(t, n, s) {
            var l, i, a = this,
                o = a.settings,
                r = o.wrapDigitsTag,
                u = e(a.$element).find(t),
                n = n.toString(),
                c = [];
            if (null == a._wrapsExists[t] && (a._wrapsExists[t] = u.length > 0), 0 == a._wrapsExists[t]) return !1;
            if (1 == o.wrapDigits)
                for (h = 0; h < n.length; h++) c[h] = n[h];
            else c[0] = n;
            if (void 0 === a._oldValues[t] && (a._oldValues[t] = []), a._oldValues[t].length > c.length) {
                i = a._oldValues[t].length - c.length, (l = u.find(r)).slice(0, i).remove(), l = u.find(r);
                for (h = 0; h < c.length; h++) l.eq(h).text(c[h]);
                a._changed = !0
            }
            if (a._oldValues[t].length < c.length) {
                if (0 == o.wrapDigits) u.text(c[0]);
                else {
                    0 == a._oldValues[t].length && u.text("");
                    for (var d = "", h = 0; h < c.length; h++) h < (i = c.length - a._oldValues[t].length) ? d += "<" + r + ' class="' + s + '">' + c[h] + "</" + r + ">" : (l = u.find(r)).eq(h - i).text(c[h]);
                    u.prepend(d)
                }
                a._changed = !0
            }
            if (a._oldValues[t].length == c.length)
                if (0 == o.wrapDigits) a._oldValues[t][0] != c[0] && (u.text(c[0]), a._changed = !0);
                else
                    for (h = 0; h < c.length; h++) a._oldValues[t][h] != c[h] && ((l = u.find(r)).eq(h).text(c[h]), a._changed = !0);
            a._oldValues[t] = [];
            for (h = 0; h < c.length; h++) a._oldValues[t][h] = c[h]
        }
    }, e.fn[i] = function(t, n, s) {
        var a = null,
            o = this.each(function() {
                var o = null;
                if (e.data(this, i)) {
                    if (o = e.data(this, i), "destroy" === t) return o.destroy(), void e.data(this, i, null);
                    var r = o[t];
                    return "function" == typeof r && (a = r.call(o, n, s)), !1
                }
                o = new l(this, t), e.data(this, i, o)
            });
        return a || o
    }
